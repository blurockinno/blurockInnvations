const Demo = () => {
  return (
    <div className="h-[800px]">
      <h1 className="text-[30px] text-white font-bold text-center pt-9">
        Experience the Demo
      </h1>
      <section className="pt-[70px] justify-center  flex">
        <div className="shadow-deep flex justify-center items-center h-[550px] w-[1000px] border-2 rounded-2xl bg-[#1C4FEA]">
