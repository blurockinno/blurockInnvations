...
const ProfileCard = ({ image, name, designation, social }) => {
  return (
    <motion.div
      ...
      className="bg-white group p-6 rounded-lg shadow-lg flex flex-col items-center text-center transition-all duration-100 ease-in-out"
    >
      <img
        src={image}
        alt={`${name}'s profile`}
        className="w-full h-68 rounded-md mb-4 object-cover overflow-hidden"
      />

      <h3 className="text-xl font-bold mb-2 group-hover:text-[#146ef5]">
        {name}
      </h3>
